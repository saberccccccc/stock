...
class DataConfig:
    ...
    # 绐楀彛鍙傛暟
    seq_len: int = 40
    target_horizon: int = 5       # 涓绘爣绛撅細棰勬祴鏈?潵N鏃ユ敹鐩婏紙榛樿?5鏃ワ級
    max_horizon: int = 10
    ...
    # ==================== 鏂板?锛氭墿灞曞洜瀛?====================
    use_macro_features: bool = False            # 瀹忚?/璧勯噾娴佸洜瀛愶紙鍖楀悜銆佽瀺璧勮瀺鍒搞€丳MI锛?    use_fundamental_features: bool = False      # 瀛ｆ姤鍩烘湰闈㈠洜瀛愶紙ROE銆佽惀鏀跺?閫熴€丳E鍒嗕綅鏁帮級
    tushare_token: Optional[str] = None         # 鍩烘湰闈㈡暟鎹甌oken锛涗负绌烘椂灏濊瘯璇诲彇鐜??鍙橀噺TUSHARE_TOKEN

    # ==================== 鏂板?锛氭ā鍨嬪?寮?====================
    use_gat: bool = False                       # GAT浜т笟閾惧浘缃戠粶
    use_stacking: bool = False                  # Stacking闆嗘垚锛圠GB鈫扵ransformer锛?
    # ==================== 鏂板?锛氬姩鎬侀?鎺?====================
    dynamic_risk_budget: bool = False           # 鍔ㄦ€侀?闄╅?绠?    max_drawdown_limit: float = 0.15            # 鏈€澶у洖鎾ゅ?蹇嶅害
    ...
    horizon_weights: Tuple[float, ...] = (0.15, 0.25, 0.35, 0.25)  # 鍚勫懆鏈焞oss鏉冮噸
